          ...
          <form onSubmit={handleNext}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
              <div className="flex flex-col">
                <label className="text-text font-semibold mb-2">Nome completo *</label>
                <input type="text" name="fullName" value={formData.fullName} onChange={handleChange} required className="border-2 border-secondary-2 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="Digite aqui..." />
              </div>
              <div className="flex flex-col">
                <label className="text-text font-semibold mb-2">CPF</label>
                <input type="text" name="cpf" value={formData.cpf} onChange={handleChange} className="border-2 border-secondary-2 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="___.___.___-__" />
              </div>
              <div className="flex flex-col">
                <label className="text-text font-semibold mb-2">Data de Nascimento *</label>
                <input type="text" name="birthDate" value={formData.birthDate} onChange={handleChange} required className="border-2 border-secondary-2 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="__/__/____" />
              </div>
              <div className="flex flex-col">
                <label className="text-text font-semibold mb-2">CEP</label>
                <input type="text" name="cep" value={formData.cep} onChange={handleChange} className="border-2 border-secondary-2 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="_____-___" />
              </div>
              <div className="flex flex-col col-span-1 md:col-span-2">
                <label className="text-text font-semibold mb-2">Endereço</label>
                <input type="text" name="address" value={formData.address} onChange={handleChange} className="border-2 border-secondary-2 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="Digite aqui..." />
              </div>
            </div>
          ...
          <form onSubmit={handleFinish}>
            <div className="flex flex-col md:flex-row gap-6 md:gap-12">
              <div className="flex-1 flex flex-col gap-6">
                <div className="flex flex-col">
                  <label className="text-text font-semibold mb-2">Nome de usuário</label>
                  <input type="text" name="username" value={formData.username} onChange={handleChange} className="border-2 border-secondary-2 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="Digite aqui..." />
                </div>
                <div className="flex flex-col">
