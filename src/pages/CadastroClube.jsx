...
const CadastroClube = () => {
  ...
  const handleFinish = (e) => {
    ...
    alert('Cadastro de clube concluído! Verifique o console para ver os dados.');
  };
          ...
          <form onSubmit={handleNext}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
              <div className="flex flex-col">
                <label className="text-gray-700 font-semibold mb-2">Nome do Clube *</label>
                <input type="text" name="clubName" value={formData.clubName} onChange={handleChange} required className="border border-gray-300 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="Digite aqui..." />
              </div>
              <div className="flex flex-col">
                <label className="text-gray-700 font-semibold mb-2">CNPJ *</label>
                <input type="text" name="cnpj" value={formData.cnpj} onChange={handleChange} required className="border border-gray-300 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="__.___.___/____-__" />
              </div>
              <div className="flex flex-col">
                <label className="text-gray-700 font-semibold mb-2">Logradouro *</label>
                <input type="text" name="address" value={formData.address} onChange={handleChange} required className="border border-gray-300 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="Digite aqui..." />
              </div>
              <div className="flex flex-col">
                <label className="text-gray-700 font-semibold mb-2">CPF *</label>
                <input type="text" name="cpf" value={formData.cpf} onChange={handleChange} required className="border border-gray-300 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="___.___.___-__" />
              </div>
            </div>
          ...
          <form onSubmit={handleNext}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
              ...
              <div className="flex flex-col">
                ...
                <input type="text" name="cep" value={formData.cep} onChange={handleChange} required className="border border-gray-300 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="_____-___" />
              </div>
              <div className="flex flex-col">
                <label className="text-gray-700 font-semibold mb-2">Endereço 2</label>
                <input type="text" name="address2" value={formData.address2} onChange={handleChange} className="border border-gray-300 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="Digite aqui..." />
              </div>
              <div className="flex flex-col">
                <label className="text-gray-700 font-semibold mb-2">CEP 2</label>
                <input type="text" name="cep2" value={formData.cep2} onChange={handleChange} className="border border-gray-300 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="_____-___" />
              </div>
              <div className="flex flex-col">
                <label className="text-gray-700 font-semibold mb-2">Endereço 3</label>
                <input type="text" name="address3" value={formData.address3} onChange={handleChange} className="border border-gray-300 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="Digite aqui..." />
              </div>
              <div className="flex flex-col">
                <label className="text-gray-700 font-semibold mb-2">CEP 3</label>
                <input type="text" name="cep3" value={formData.cep3} onChange={handleChange} className="border border-gray-300 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="_____-___" />
              </div>
            </div>
          ...
          <form onSubmit={handleNext}>
            <div className="flex flex-col gap-6">
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1 flex flex-col">
                  <label className="text-gray-700 font-semibold mb-2">Telefone *</label>
                  <input type="text" name="phone" value={formData.phone} onChange={handleChange} required className="border border-gray-300 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="(__) _ ____-____" />
                </div>
              </div>
              <div className="flex flex-col md:flex-row gap-6">
                <div className="flex-1 flex flex-col">
          ...
          <form onSubmit={handleFinish}>
            <div className="flex flex-col md:flex-row gap-6 md:gap-12">
              <div className="flex-1 flex flex-col gap-6">
                <div className="flex flex-col">
                  <label className="text-gray-700 font-semibold mb-2">Nome de exibição do clube</label>
                  <input type="text" name="displayName" value={formData.displayName} onChange={handleChange} className="border border-gray-300 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="Digite aqui..." />
                </div>
                <div className="flex flex-col">
              ...
              <div className="flex flex-col items-center justify-center gap-2">
                ...
                <label htmlFor="club-logo-upload" className="bg-purple-700 text-white text-sm py-2 px-4 rounded-lg cursor-pointer hover:bg-purple-800 transition duration-300">
                  Adicionar Imagem
                </label>
      ...
      <div className="flex justify-center p-8 md:p-12">
        <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-2xl">
          <div className="flex justify-center mb-8">
            ...
            <div className={`w-10 h-10 rounded-full flex items-center justify-center ml-4 ${currentStep === 4 ? 'bg-purple-700 text-white' : 'border border-gray-300 text-gray-400'}`}>4</div>
          </div>
